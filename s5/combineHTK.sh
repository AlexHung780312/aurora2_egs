...
for train in Clean Multi; do
if [ -d data/Aurora2.TR.$train ]; then
	rm -rf data/Aurora2.TR.$train
	./utils/combine_data.sh data/Aurora2.TR.$train data/Aurora2.TR.${train}90 data/Aurora2.TR.${train}Dev10
fi
done
